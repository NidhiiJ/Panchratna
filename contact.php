...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    // Store form values (trimmed for safety)
                ...
                <div class="col-lg-7">
                    ...
                    <div class="contact-us-form">
                        ...
                        <div class="contact-form">
                            <!-- Contact Form Start -->
                            <form id="contactForm" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" data-toggle="validator" class="wow fadeInUp" data-wow-delay="0.5s">
                                <div class="row">
